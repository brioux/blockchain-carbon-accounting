...
export default class LedgerIntegration {
    ...
    constructor(private readonly app: Express) {
        ...
        this.log = LoggerProvider.getOrCreate({
            label: 'LedgerIntegration',
            level: this.ledgerConfig.logLevel,
        });
    ...
    private registerRouters() {
        ...
        this.app.use(
            '/api/v1/utilityemissionchannel/emissionscontract',
            this.carbonAccountingRouter.router,
        );

        // /api/v1/fabricRegistry : endpoints for interacting fabric-ca
        this.app.use(
            '/api/v1/utilityemissionchannel/registerEnroll',
            this.fabricRegistryRouter.router,
        );
        ...
        this.app.use(
            '/api/v1/utilityemissionchannel/emissionscontract',
            this.utilityEmissionsChannelRouter.router,
        );
    }
